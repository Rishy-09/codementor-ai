  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex relative">
        ...
        {/* --- CHAT SIDEBAR --- */}
        <div 
          className={`fixed inset-y-0 right-0 w-96 bg-gray-900 border-l border-gray-800 transform transition-transform duration-300 ease-in-out z-20 flex flex-col shadow-2xl ${showChat ? 'translate-x-0' : 'translate-x-full'}`}
